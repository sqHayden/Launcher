...
import com.idx.launcher.map.adapter.MyImgAdapter;
...
public class DetailFragment extends Fragment implements ParentCallBack {
    ...
    private void dealWithJson(String json) {
        ...
        if(jsonData!=null) {
            ...
            if (jsonData.getDomain().equals(LauncherActions.Map.TARGET_RESTAURANT) && jsonData.getType().equals("restaurant")) {
                restaurantResponse = gson.fromJson(json, ImoranRestaurantResponse.class);
            } else if (jsonData.getDomain().equals(LauncherActions.Map.TARGET_VIEWSPOT) && jsonData.getType().equals("viewspot")) {
