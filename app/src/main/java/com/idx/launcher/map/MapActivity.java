...
import com.idx.launcher.map.Interface.BusRouteListener;
...
import com.idx.launcher.map.fragment.BusDetailFragment;
import com.idx.launcher.map.fragment.DetailFragment;
import com.idx.launcher.map.fragment.LeftFragment;
import com.idx.launcher.map.fragment.RouteFragment;
        ...
        if (json.length() > 2) {
            ...
            if (jsonData != null) {
                ...
                //处理返回的情况
                    ...
                    if(isBackToList){
                        //处理返回到List
                        VUIDataEntity.wrapData(((LauncherApplication) getApplication()).getDataEntity(), mListPageId, mListQueryId);
                    }else{
                        //覆盖为item
