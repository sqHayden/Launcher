...
public class LauncherExecutors {
    ...
    LauncherExecutors(Executor mainExecutor, Executor ioExecutor, Executor networkExecutor) {
        mMainExecutor = mainExecutor;
        mIoExecutor = ioExecutor;
        mNetworkExecutor = networkExecutor;
    }

    public LauncherExecutors(){this(new MainExecutor(),new IoExecutor(), Executors.newFixedThreadPool(THREAD_COUNT));}
