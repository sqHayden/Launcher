...
import com.idx.launcher.utils.ImoranResponseToBeanUtils;
...
import com.idx.launcher.weather.HandlerWeatherUtil;
import com.idx.launcher.weather.data.ContentWeather;
import com.idx.launcher.weather.data.ImoranResponse;
...
//                mCallRepository.deleteCall();
    ...
    private void getWeather_service(){
        VUIDataEntity.wrapData(((LauncherApplication)getApplication()).getDataEntity(), "","");
