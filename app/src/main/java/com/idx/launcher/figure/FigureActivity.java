package com.idx.launcher.figure;
...
import com.idx.launcher.figure.data.Card;
import com.idx.launcher.figure.data.Figure;
import com.idx.launcher.figure.data.ImoranResponseFigure;
import com.idx.launcher.figure.data.Personal;
import com.idx.launcher.imoran.TTSManager;
import com.idx.launcher.map.mapUtils.ToastUtil;
import com.idx.launcher.news.util.MyTextView;
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if ((mIService.getJson()).equals("") || mIService.getJson() == null) {
                if (temporaryJson != null) {
                    ...
                    //返回时为空处理
                    mLoading.setText(getString(R.string.error_json_message));
