...
import com.idx.launcher.takeout.adapter.TakeoutAdapter;
import com.idx.launcher.takeout.data.takeout.ImoranTSResponse;
import com.idx.launcher.takeout.data.takeout.TSContent;
import com.idx.launcher.takeout.data.takeout.TakeoutShop;
...
public class TakeoutActivity extends BaseActivity {
    ...
    protected void onPause() {
        ...
        unbindService(mConn);
        ((LauncherApplication) getApplication()).getDataEntity().setScenes(null);
        VUIDataEntity.wrapData(((LauncherApplication) getApplication()).getDataEntity(), "pageId_default", "");
    }
