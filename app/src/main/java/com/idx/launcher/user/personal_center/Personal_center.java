package com.idx.launcher.user.personal_center;
...
import com.idx.launcher.user.personal_center.address.AddressActivity;
import com.idx.launcher.user.personal_center.order.OrderActivity;
import com.idx.launcher.user.personal_center.order.orderbean.Order_list;
import com.idx.launcher.user.personal_center.order.orderbean.Orders;
import com.idx.launcher.user.personal_center.order.orderbean.Reply;
import com.idx.launcher.user.personal_center.order.orderbean.Root;
...
public class Personal_center extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        bitmap_beijing = BitmapUtils.decodeBitmapFromResources(this,R.drawable.home_bg);
