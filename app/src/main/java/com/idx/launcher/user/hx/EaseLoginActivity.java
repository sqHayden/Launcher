package com.idx.launcher.user.hx;
    ...
    public void login(){
        ...
        EMClient.getInstance().login(username, password, new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                SpUtils.put(LauncherApplication.getInstance().getBaseContext(),"hyphenate_current_user",uuid);

                SpUtils.put(LauncherApplication.getInstance().getBaseContext(), "username", username);
                SpUtils.put(LauncherApplication.getInstance().getBaseContext(), "password", password);
                dialog.dismiss();
