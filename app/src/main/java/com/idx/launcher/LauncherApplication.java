...
import com.idx.launcher.videocall.call.VideoCallReceiver;
...
public class LauncherApplication extends MultiDexApplication {
    ...
    private static LauncherApplication mLauncherApplication;
    ...
    public synchronized static LauncherApplication getInstance() {
